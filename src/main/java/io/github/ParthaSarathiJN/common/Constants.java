...
public class Constants {
    ...
    public static final byte GET_REQ = 1;
    public static final byte INSERT_REQ = 2;
    public static final byte UPDATE_REQ = 3;
    public static final byte DELETE_REQ = 4;

    public static final byte GET_RESP = -1;
