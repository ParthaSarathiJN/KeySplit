...
public class KeySplitClient2 {

    private static final Logger logger = LoggerFactory.getLogger(KeySplitClient2.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        KeySplitClient2 keySplitClient2 = new KeySplitClient2();

        keySplitClient2.startKeySplitClient();
    }
